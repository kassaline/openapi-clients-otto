...
/**
 * AvailableQuantityRequestDTOV2QuantitiesV2 Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AvailableQuantityRequestDTOV2QuantitiesV2 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AvailableQuantityRequestDTOV2__Quantities-V2';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantityRequestDTOV2QuantitiesV2., must be smaller than or equal to 999999999.');
        }
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantityRequestDTOV2QuantitiesV2., must be bigger than or equal to 0.');
        }

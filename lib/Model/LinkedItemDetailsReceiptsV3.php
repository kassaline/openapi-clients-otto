 ...
 */
class LinkedItemDetailsReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        ...
        'itemPartnerName' => 'string',
        'sku' => 'string',
        'articleNumber' => 'string',
        'productTitle' => 'string',
        'serviceRelations' => '\OpenAPI\Client\Otto\Model\ServiceRelationReceiptsV3[]',
    ];
    ...
    protected static $openAPIFormats = [
        'itemReceiptNumber' => null,
        'itemPartnerName' => null,
        'sku' => null,
        'articleNumber' => null,
        'productTitle' => null,
    ...
    protected static array $openAPINullables = [
        'itemReceiptNumber' => false,
        'itemPartnerName' => false,
        'sku' => false,
        'articleNumber' => false,
        'productTitle' => false,
        'serviceRelations' => false,
    ];
    ...
    protected static $attributeMap = [
        ...
        'itemPartnerName' => 'itemPartnerName',
        'sku' => 'sku',
    ...
    protected static $setters = [
        'itemReceiptNumber' => 'setItemReceiptNumber',
        'itemPartnerName' => 'setItemPartnerName',
        'sku' => 'setSku',
    ...
    protected static $getters = [
        'itemReceiptNumber' => 'getItemReceiptNumber',
        'itemPartnerName' => 'getItemPartnerName',
        'sku' => 'getSku',
    ...
    {
        $this->setIfExists('itemReceiptNumber', $data ?? [], null);
        $this->setIfExists('itemPartnerName', $data ?? [], null);
        $this->setIfExists('sku', $data ?? [], null);
        $this->setIfExists('articleNumber', $data ?? [], null);
        $this->setIfExists('productTitle', $data ?? [], null);
        $this->setIfExists('serviceRelations', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['serviceRelations'] === null) {
            $invalidProperties[] = "'serviceRelations' can't be null";
        }
    ...
    /**
     * Gets itemReceiptNumber
     *
     * @return string|null
     */
    public function getItemReceiptNumber()
    {
        return $this->container['itemReceiptNumber'];
    }

    /**
     * Sets itemReceiptNumber
     *
     * @param  string|null  $itemReceiptNumber  Human-readable identifier refers to the receipt the linked item was billed. </br> Displayed only if item is billed with another receipt. </br> In case of receiptType * **PURCHASE** - **receiptNumber of purchase receipt**.</br> If this field is not present, you will find information in receipt.receiptNumber * **REFUND** - **receiptNumber of purchase receipt**. </br> If this field is not present ,you will find information in receipt.linkedReceiptNumber
     * @return self
     */
    public function setItemReceiptNumber($itemReceiptNumber)
    {
        if (is_null($itemReceiptNumber)) {
            throw new \InvalidArgumentException('non-nullable itemReceiptNumber cannot be null');
        }
        $this->container['itemReceiptNumber'] = $itemReceiptNumber;

        return $this;
    }

    /**
     * Gets itemPartnerName
     *
     * @return string|null
     */
    public function getItemPartnerName()
    {
        return $this->container['itemPartnerName'];
    }

    /**
     * Sets itemPartnerName
     *
     * @param  string|null  $itemPartnerName  Name of the partner who sold the linked item. </br>Displayed only if the partner is different from partner of the receipt
     * @return self
     */
    public function setItemPartnerName($itemPartnerName)
    {
        if (is_null($itemPartnerName)) {
            throw new \InvalidArgumentException('non-nullable itemPartnerName cannot be null');
        }
        $this->container['itemPartnerName'] = $itemPartnerName;
     ...
     * Sets articleNumber
     *
     * @param  string  $articleNumber  Unique Identifier of linked item the customer knows from order process.  ATTENTION: Different from the previous version, the field also contains the promotion. In last version the promotion was provided separately
     * @return self
     */
     ...
     * Sets productTitle
     *
     * @param  string  $productTitle  Product description of linked item the customer knows from the order process
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Otto\Model\ServiceRelationReceiptsV3[]
     */
     ...
     *
     * @param  \OpenAPI\Client\Otto\Model\ServiceRelationReceiptsV3[]  $serviceRelations  List of ServiceRelation objects. </br>Contains entries if services were sold  together with items otherwise list is empty
     * @return self
     */
    public function setServiceRelations($serviceRelations)
    {
        if (is_null($serviceRelations)) {
            throw new \InvalidArgumentException('non-nullable serviceRelations cannot be null');
        }

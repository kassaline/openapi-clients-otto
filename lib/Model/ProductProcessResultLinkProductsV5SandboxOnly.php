...
/**
 * ProductProcessResultLinkProductsV5SandboxOnly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class ProductProcessResultLinkProductsV5SandboxOnly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessResultLink__Products-V5 (sandbox only)';
    ...
    public const REL_FAILED = 'failed';
    public const REL_SUCCEEDED = 'succeeded';
    public const REL_UNCHANGED = 'unchanged';

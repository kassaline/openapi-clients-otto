 ...
 */
class ItemPartialRefundPositionReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'partialRefundDetails' => '\OpenAPI\Client\Otto\Model\PartialRefundDetailsReceiptsV3',
        'lineNumber' => 'int',
        'sku' => 'string',
    ...
    protected static $setters = [
        'partialRefundDetails' => 'setPartialRefundDetails',
    ...
    protected static $getters = [
        'partialRefundDetails' => 'getPartialRefundDetails',
    ...
    {
        $this->setIfExists('partialRefundDetails', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['partialRefundAmount'] === null) {
            $invalidProperties[] = "'partialRefundAmount' can't be null";
        }
    ...
    /**
     * Gets partialRefundDetails
     *
     * @return \OpenAPI\Client\Otto\Model\PartialRefundDetailsReceiptsV3|null
     */
    public function getPartialRefundDetails()
    {
        return $this->container['partialRefundDetails'];
    }

    /**
     * Sets partialRefundDetails
     *
     * @param  \OpenAPI\Client\Otto\Model\PartialRefundDetailsReceiptsV3|null  $partialRefundDetails  partialRefundDetails
     * @return self
     */
    public function setPartialRefundDetails($partialRefundDetails)
    {
        if (is_null($partialRefundDetails)) {
            throw new \InvalidArgumentException('non-nullable partialRefundDetails cannot be null');
        }
        $this->container['partialRefundDetails'] = $partialRefundDetails;
     ...
     * Sets articleNumber
     *
     * @param  string  $articleNumber  Unique Identifier of item the customer knows from order process
     * @return self
     */
     ...
     *
     * @param  string|null  $variationAttributes  Additional attributes for unique description of  item, if different variants of the item are possible. (String of comma seperated dimensions)  ATTENTION: In previous version, the information exists as dimensions
     * @return self
     */
     ...
     *
     * @param  string[]  $positionItemIds  List of unique identifiers of specific instances of ordered items. </br>A (salesOrder)PositionItem is the smallest unit of an item that can be ordered
     * @return self
     */
     ...
     *
     * @param  \OpenAPI\Client\Otto\Model\PriceReceiptsV3  $partialRefundAmount  partialRefundAmount
     * @return self
     */

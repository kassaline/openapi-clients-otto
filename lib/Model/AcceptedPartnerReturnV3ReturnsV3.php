...
/**
 * AcceptedPartnerReturnV3ReturnsV3 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class AcceptedPartnerReturnV3ReturnsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptedPartnerReturnV3__Returns-V3';
    ...
    protected static $openAPITypes = [
        'positionItems' => '\OpenAPI\Client\Otto\Model\AcceptedPositionItemReturnsV3[]'
    ];
    ...
    */
     ...
     * Sets positionItems
     *
     * @param \OpenAPI\Client\Otto\Model\AcceptedPositionItemReturnsV3[] $positionItems List of all the items received from partner
     *
     * @return self
     */

 ...
 */
class AddressOrdersV4 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets countryCode
     *
     * @param  string  $countryCode  The country in SO-3166-1 Alpha-3 format
     * @return self
     */
     ...
     * Sets email
     *
     * @param  string|null  $email  The e-mail address; if part of the invoice address it's a pseudonymized e-mail address
     * @return self
     */

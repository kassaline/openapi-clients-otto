...
class GetShippingProfileResponseShippingProfilesV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'workingDays' => null,
        'orderCutoff' => 'HH:MM, 24 hours format, CET timezone',
        'deliveryType' => null,
    ...
    {
        $this->setIfExists('shippingProfileId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/UUID4 string/", $this->container['shippingProfileId'])) {
            $invalidProperties[] = "invalid value for 'shippingProfileId', must be conform to the pattern /UUID4 string/.";
        }
     ...
     *
     * @param string $shippingProfileId Unique identifier for each shipping profile
     *
     * @return self
     */
    public function setShippingProfileId($shippingProfileId)
    {
        if (is_null($shippingProfileId)) {
            throw new \InvalidArgumentException('non-nullable shippingProfileId cannot be null');
        }

        if ((!preg_match("/UUID4 string/", ObjectSerializer::toString($shippingProfileId)))) {
            throw new \InvalidArgumentException("invalid value for \$shippingProfileId when calling GetShippingProfileResponseShippingProfilesV1., must conform to the pattern /UUID4 string/.");
        }
     ...
     *
     * @param string $shippingProfileName The name of the shipping profile
     *
     * @return self
     */
     ...
     * Sets workingDays
     *
     * @param string[] $workingDays The days of the week on which the partner is available to process orders
     *
     * @return self
     */
    public function setWorkingDays($workingDays)
    {
        ...
        if (array_diff($workingDays, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'workingDays', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     * Sets orderCutoff
     *
     * @param string $orderCutoff OrderCutoff specifies the time for orders to be placed, so the ProcessingTime starts within the same day. <br> This must be in half hour duration in (HH:MM) 24 hours format and in CET time.
     *
     * @return self
     */
     ...
     *
     * @param int $defaultProcessingTime DefaultProcessingTime describes the time the partner needs to prepare the order for a shipment.
     *
     * @return self
     */
    public function setDefaultProcessingTime($defaultProcessingTime)
    {
        ...
        if (($defaultProcessingTime > 99)) {
            throw new \InvalidArgumentException('invalid value for $defaultProcessingTime when calling GetShippingProfileResponseShippingProfilesV1., must be smaller than or equal to 99.');
        }
        if (($defaultProcessingTime < 1)) {
            throw new \InvalidArgumentException('invalid value for $defaultProcessingTime when calling GetShippingProfileResponseShippingProfilesV1., must be bigger than or equal to 1.');
        }
     ...
     * Sets transportTime
     *
     * @param int $transportTime The time the carrier needs from collecting the order from partners warehouse till the first delivery attempt.
     *
     * @return self
     */
    public function setTransportTime($transportTime)
    {
        ...
        if (($transportTime > 99)) {
            throw new \InvalidArgumentException('invalid value for $transportTime when calling GetShippingProfileResponseShippingProfilesV1., must be smaller than or equal to 99.');
        }
        if (($transportTime < 1)) {
            throw new \InvalidArgumentException('invalid value for $transportTime when calling GetShippingProfileResponseShippingProfilesV1., must be bigger than or equal to 1.');
        }

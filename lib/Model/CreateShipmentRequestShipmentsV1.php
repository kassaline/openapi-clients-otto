 ...
 */
class CreateShipmentRequestShipmentsV1 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateShipmentRequest__Shipments-V1';
     ...
     * Gets trackingKey
     *
     * @return \OpenAPI\Client\Otto\Model\TrackingKeyShipmentsV1
     */
     ...
     * Sets trackingKey
     *
     * @param  \OpenAPI\Client\Otto\Model\TrackingKeyShipmentsV1  $trackingKey  trackingKey
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Otto\Model\AddressShipmentsV1
     */
     ...
     *
     * @param  \OpenAPI\Client\Otto\Model\AddressShipmentsV1  $shipFromAddress  shipFromAddress
     * @return self
     */
     ...
     * Gets positionItems
     *
     * @return \OpenAPI\Client\Otto\Model\PositionItemShipmentsV1[]
     */
     ...
     * Sets positionItems
     *
     * @param  \OpenAPI\Client\Otto\Model\PositionItemShipmentsV1[]  $positionItems  The position items included in shipment.
     * @return self
     */
    public function setPositionItems($positionItems)
    {
        ...
        if ((count($positionItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $positionItems when calling CreateShipmentRequestShipmentsV1., number of items must be greater than or equal to 1.');
        }

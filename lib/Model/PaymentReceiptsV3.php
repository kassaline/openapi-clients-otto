 ...
 */
class PaymentReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     *
     * @param  string  $paymentProvider  Payment Provider chosen for the order. </br> Possible values: * **PLAZA** -  Ratepay * **OTTOPAYMENT** - OTTO Payments
     * @return self
     */
     ...
     * Sets paymentMethod
     *
     * @param  string  $paymentMethod  Payment method chosen by the customer to pay for this order
     * @return self
     */

 ...
 */
class LinkPriceReductionsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Link__Price-Reductions-V1';
    ...
    */
     ...
     * Sets rel
     *
     * @param string|null $rel The relation type of the link. See also https://www.iana.org/assignments/link-relations/link-relations.xhtml. The relation type 'next' is used for paging
     *
     * @return self
     */

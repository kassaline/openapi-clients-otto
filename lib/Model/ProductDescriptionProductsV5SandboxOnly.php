...
/**
 * ProductDescriptionProductsV5SandboxOnly Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductDescriptionProductsV5SandboxOnly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductDescription__Products-V5 (sandbox only)';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'bulletPoints' => 'string[]',
        'attributes' => '\OpenAPI\Client\Otto\Model\AttributeProductsV5SandboxOnly[]'
    ];
    ...
    */
     ...
     * Gets attributes
     *
     * @return \OpenAPI\Client\Otto\Model\AttributeProductsV5SandboxOnly[]|null
     */
     ...
     * Sets attributes
     *
     * @param \OpenAPI\Client\Otto\Model\AttributeProductsV5SandboxOnly[]|null $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return self
     */

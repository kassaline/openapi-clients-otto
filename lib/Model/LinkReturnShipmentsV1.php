...
/**
 * LinkReturnShipmentsV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class LinkReturnShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Link__ReturnShipments-V1';
    ...
    */
     ...
     * Sets rel
     *
     * @param string|null $rel The relation type of the link. See also https://www.iana.org/assignments/link-relations/link-relations.xhtml. The relation type 'next' is used for paging. The relation type 'self' refers to the url of the ressource
     *
     * @return self
     */

 ...
 */
class CategoryGroupProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CategoryGroup__Products-V3';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'attributes' => '\OpenAPI\Client\Otto\Model\AttributeDefinitionProductsV3[]',
        'createdAt' => '\DateTime',
        'lastModified' => '\DateTime',
        'additionalRequirements' => '\OpenAPI\Client\Otto\Model\AdditionalRequirementProductsV3[]',
    ];
     ...
     * Gets attributes
     *
     * @return \OpenAPI\Client\Otto\Model\AttributeDefinitionProductsV3[]|null
     */
     ...
     * Sets attributes
     *
     * @param  \OpenAPI\Client\Otto\Model\AttributeDefinitionProductsV3[]|null  $attributes  list of the market place attributes for the categories of this group.
     * @return self
     */
     ...
     * Sets createdAt
     *
     * @param  \DateTime|null  $createdAt  creation date date of the category.
     * @return self
     */
     ...
     * Sets lastModified
     *
     * @param  \DateTime|null  $lastModified  last modification date of the category.
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Otto\Model\AdditionalRequirementProductsV3[]|null
     */
     ...
     *
     * @param  \OpenAPI\Client\Otto\Model\AdditionalRequirementProductsV3[]|null  $additionalRequirements  a list of general requirements for certain product attributes that apply to all categories in the category group
     * @return self
     */

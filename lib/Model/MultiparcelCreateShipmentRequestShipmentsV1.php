 ...
 */
class MultiparcelCreateShipmentRequestShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiparcelCreateShipmentRequest__Shipments-V1';
    ...
    protected static $openAPITypes = [
        'trackingKey' => '\OpenAPI\Client\Otto\Model\MultiparcelTrackingKeyShipmentsV1',
        'shipDate' => '\DateTime',
        'shipFromAddress' => '\OpenAPI\Client\Otto\Model\AddressShipmentsV1',
        'positionItems' => '\OpenAPI\Client\Otto\Model\MultiparcelPositionItemShipmentsV1[]'
    ];
    ...
    */
     ...
     * Gets trackingKey
     *
     * @return \OpenAPI\Client\Otto\Model\MultiparcelTrackingKeyShipmentsV1
     */
     ...
     * Sets trackingKey
     *
     * @param \OpenAPI\Client\Otto\Model\MultiparcelTrackingKeyShipmentsV1 $trackingKey trackingKey
     *
     * @return self
     */
     ...
     * Gets positionItems
     *
     * @return \OpenAPI\Client\Otto\Model\MultiparcelPositionItemShipmentsV1[]
     */
     ...
     * Sets positionItems
     *
     * @param \OpenAPI\Client\Otto\Model\MultiparcelPositionItemShipmentsV1[] $positionItems The position items included in shipment.
     *
     * @return self
     */
    public function setPositionItems($positionItems)
    {
        ...
        if ((count($positionItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $positionItems when calling MultiparcelCreateShipmentRequestShipmentsV1., number of items must be greater than or equal to 1.');
        }

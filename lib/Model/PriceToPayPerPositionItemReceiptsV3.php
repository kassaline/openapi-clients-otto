 ...
 */
class PriceToPayPerPositionItemReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceToPayPerPositionItem__Receipts-V3';
    ...
    protected static $openAPITypes = [
        ...
        'priceToPay' => '\OpenAPI\Client\Otto\Model\PriceReceiptsV3'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('priceToPay', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['priceToPay'] === null) {
            $invalidProperties[] = "'priceToPay' can't be null";
        }
    ...
    {
        return $this->container['priceToPay'];
    }

    /**
     * Sets priceToPay
     *
     * @param \OpenAPI\Client\Otto\Model\PriceReceiptsV3 $priceToPay priceToPay
     *
     * @return self
     */
    public function setPriceToPay($priceToPay)
    {
        if (is_null($priceToPay)) {
            throw new \InvalidArgumentException('non-nullable priceToPay cannot be null');
        }
        $this->container['priceToPay'] = $priceToPay;

...
/**
 * TrackingKeyReturnShipmentsV1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class TrackingKeyReturnShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingKey__ReturnShipments-V1';
    ...
    */
     ...
     * Sets trackingNumber
     *
     * @param string $trackingNumber The tracking number assigned by the carrier.
     *
     * @return self
     */

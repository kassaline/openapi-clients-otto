 ...
 */
class PricingProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets vat
     *
     * @param  string  $vat  The value added tax that is included in the sales price, currently only FULL allowed
     * @return self
     */

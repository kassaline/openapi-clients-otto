 ...
 * @category Class
 *
 * @description Costs of an object There are different definitions of Price objects in Receipt structure:   * **unitPrice** - Original price for quantity a line item object   * **positionSum** - Price for quantity x unitPrice of a line item object minus reductions of all sub priceModification objects, if exist   * **partialRefundAmount** - Granted reduction by the partner on item   * **priceModificationAmount** - Total reduction for the super ordinated line item object. If the line item object has a quantity, this is already been taken into account in this amount.   * **priceToPay** - Price for quantity one minus all instant reductions like partner discount ... when selling (excl. earlier partial refunds).&lt;/br&gt;Only available on receipts of receiptType PURCHASE.
 *
 * @author   OpenAPI Generator team
 *
 * @link     https://openapi-generator.tech
 ...
 */
class PriceReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * Sets taxType
     *
     * @param  string  $taxType  The fields indicates what kind of tax the price object includes.</br> Currently prices of the following taxTypes are possible * **VAT** - vat rate
     * @return self
     */

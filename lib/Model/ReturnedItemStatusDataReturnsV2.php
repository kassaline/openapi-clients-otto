...
/**
 * ReturnedItemStatusDataReturnsV2 Class Doc Comment
 *
 * @category Class
 *
 ...
 */
class ReturnedItemStatusDataReturnsV2 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReturnedItemStatusData__Returns-V2';
    ...
    protected static $openAPITypes = [
        'condition' => 'string',
        'returnTrackingKey' => '\OpenAPI\Client\Otto\Model\ReturnTrackingKeyReturnsV2',
        'orderNumber' => 'string',
        'ottoWarehouseID' => 'string',
        'reason' => 'string',
    ];
    ...
    protected static array $openAPINullables = [
        'condition' => false,
        'returnTrackingKey' => false,
        'orderNumber' => false,
        'ottoWarehouseID' => false,
        'reason' => false,
    ];
    ...
    protected static $attributeMap = [
        'condition' => 'condition',
        'returnTrackingKey' => 'returnTrackingKey',
        'orderNumber' => 'orderNumber',
        'ottoWarehouseID' => 'ottoWarehouseID',
        'reason' => 'reason',
    ];
    ...
    protected static $setters = [
        ...
        'returnTrackingKey' => 'setReturnTrackingKey',
        'orderNumber' => 'setOrderNumber',
        'ottoWarehouseID' => 'setOttoWarehouseID',
        'reason' => 'setReason',
    ];
    ...
    protected static $getters = [
        ...
        'returnTrackingKey' => 'getReturnTrackingKey',
        'orderNumber' => 'getOrderNumber',
        'ottoWarehouseID' => 'getOttoWarehouseID',
        'reason' => 'getReason',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('returnTrackingKey', $data ?? [], null);
        $this->setIfExists('orderNumber', $data ?? [], null);
        $this->setIfExists('ottoWarehouseID', $data ?? [], null);
    ...
    /**
     * Gets returnTrackingKey
     *
     * @return \OpenAPI\Client\Otto\Model\ReturnTrackingKeyReturnsV2|null
     */
    public function getReturnTrackingKey()
    {
        return $this->container['returnTrackingKey'];
    }

    /**
     * Sets returnTrackingKey
     *
     * @param  \OpenAPI\Client\Otto\Model\ReturnTrackingKeyReturnsV2|null  $returnTrackingKey  returnTrackingKey
     * @return self
     */
    public function setReturnTrackingKey($returnTrackingKey)
    {
        if (is_null($returnTrackingKey)) {
            throw new \InvalidArgumentException('non-nullable returnTrackingKey cannot be null');
        }
        $this->container['returnTrackingKey'] = $returnTrackingKey;
    ...
    /**
     * Gets ottoWarehouseID
     *
     * @return string|null
     */
    public function getOttoWarehouseID()
    {
        return $this->container['ottoWarehouseID'];
    }

    /**
     * Sets ottoWarehouseID
     *
     * @param  string|null  $ottoWarehouseID  This is the unique id which helps partner identify the misdirected item
     * @return self
     */
    public function setOttoWarehouseID($ottoWarehouseID)
    {
        if (is_null($ottoWarehouseID)) {
            throw new \InvalidArgumentException('non-nullable ottoWarehouseID cannot be null');
        }
        $this->container['ottoWarehouseID'] = $ottoWarehouseID;

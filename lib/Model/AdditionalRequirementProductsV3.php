<?php
/**
 * AdditionalRequirementProductsV3
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 */
class AdditionalRequirementProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AdditionalRequirement__Products-V3';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'reference' => 'string',
        'condition' => '\OpenAPI\Client\Otto\Model\ConditionProductsV3',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('jsonPath', $data ?? [], null);
    ...
    {
        if (is_null($jsonPath)) {
            throw new \InvalidArgumentException('non-nullable jsonPath cannot be null');
        }
     ...
     * Gets condition
     *
     * @return \OpenAPI\Client\Otto\Model\ConditionProductsV3|null
     */
     ...
     * Sets condition
     *
     * @param  \OpenAPI\Client\Otto\Model\ConditionProductsV3|null  $condition  condition
     * @return self
     */

...
/**
 * AmountOrdersV4 Class Doc Comment
 *
 * @category Class
 * @description Amount
 * @package  OpenAPI\Client\Otto
 ...
 */
class AmountOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Amount__Orders-V4';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling AmountOrdersV4., must be bigger than or equal to 1.');
        }

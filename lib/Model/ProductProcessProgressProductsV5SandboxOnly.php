...
/**
 * ProductProcessProgressProductsV5SandboxOnly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class ProductProcessProgressProductsV5SandboxOnly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessProgress__Products-V5 (sandbox only)';
    ...
    protected static $openAPITypes = [
        ...
        'unchanged' => 'int',
        'pingAfter' => '\DateTime',
        'links' => '\OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV5SandboxOnly[]'
    ];
    ...
    */
     ...
     * Sets pingAfter
     *
     * @param \DateTime|null $pingAfter recommendation when to poll this resource again to receive a meaningful update - ISO8601 date
     *
     * @return self
     */
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV5SandboxOnly[]|null
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV5SandboxOnly[]|null $links a list of links that can be used to access detailed information about the process result
     *
     * @return self
     */

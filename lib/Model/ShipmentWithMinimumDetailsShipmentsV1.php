 ...
 */
class ShipmentWithMinimumDetailsShipmentsV1 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ShipmentWithMinimumDetails__Shipments-V1';
    ...
    public function setStates($states)
    {
        ...
        if ((count($states) < 0)) {
            throw new \InvalidArgumentException('invalid length for $states when calling ShipmentWithMinimumDetailsShipmentsV1., number of items must be greater than or equal to 0.');
        }

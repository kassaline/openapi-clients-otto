...
/**
 * ProductDescriptionProductsV3 Class Doc Comment
 *
 * @category Class
 *
 ...
 */
class ProductDescriptionProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductDescription__Products-V3';
     ...
     * Gets attributes
     *
     * @return \OpenAPI\Client\Otto\Model\AttributeProductsV3[]|null
     */
     ...
     * Sets attributes
     *
     * @param  \OpenAPI\Client\Otto\Model\AttributeProductsV3[]|null  $attributes  Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     * @return self
     */

 ...
 */
class ReceiptReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public const PARTIAL_REFUND_TYPE_COMPLAINT_ITEM = 'REFUND_COMPLAINT_ITEM';

    public const PARTIAL_REFUND_TYPE_PAYPAL_DISPUTE = 'REFUND_PAYPAL_DISPUTE';
     ...
     *
     * @param  object[]|null  $totalsReductions  Reduction amounts on total value of receipts
     * @return self
     */

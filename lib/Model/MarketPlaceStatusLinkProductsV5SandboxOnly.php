...
/**
 * MarketPlaceStatusLinkProductsV5SandboxOnly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class MarketPlaceStatusLinkProductsV5SandboxOnly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceStatusLink__Products-V5 (sandbox only)';
    ...
    public const REL_VARIATION = 'variation';
    public const REL_SHOP = 'shop';

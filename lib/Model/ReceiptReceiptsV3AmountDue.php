 ...
 */
class ReceiptReceiptsV3AmountDue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receipt__Receipts_V3_amountDue';

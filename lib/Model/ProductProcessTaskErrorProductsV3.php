<?php
/**
 * ProductProcessTaskErrorProductsV3
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ProductProcessTaskErrorProductsV3 Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ProductProcessTaskErrorProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductProcessTaskError__Products-V3';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('logref', $data ?? [], null);
    }
    ...
    {
        if (is_null($logref)) {
            throw new \InvalidArgumentException('non-nullable logref cannot be null');
        }

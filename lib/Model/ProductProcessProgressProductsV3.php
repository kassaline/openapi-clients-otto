...
/**
 * ProductProcessProgressProductsV3 Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ProductProcessProgressProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductProcessProgress__Products-V3';
    ...
    protected static $openAPITypes = [
        ...
        'unchanged' => 'int',
        'pingAfter' => '\DateTime',
        'links' => '\OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV3[]',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pingAfter', $data ?? [], null);
    ...
    {
        if (is_null($pingAfter)) {
            throw new \InvalidArgumentException('non-nullable pingAfter cannot be null');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV3[]|null
     */
     ...
     * Sets links
     *
     * @param  \OpenAPI\Client\Otto\Model\ProductProcessResultLinkProductsV3[]|null  $links  a list of links that can be used to access detailed information about the process result
     * @return self
     */

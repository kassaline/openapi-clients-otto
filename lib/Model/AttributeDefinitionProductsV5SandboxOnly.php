...
/**
 * AttributeDefinitionProductsV5SandboxOnly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Otto
 * @author   OpenAPI Generator team
 ...
 */
class AttributeDefinitionProductsV5SandboxOnly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttributeDefinition__Products-V5 (sandbox only)';

 ...
 */
class DeliveryCostReceiptsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public const DELIVERY_COST_TYPE_STANDARD = 'DELIVERY_FEE_STANDARD';

    public const DELIVERY_COST_TYPE_FREIGHT_SURCHARGE = 'DELIVERY_FEE_FREIGHT_SURCHARGE';

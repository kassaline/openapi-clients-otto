...
/**
 * LinkReceiptsV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class LinkReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Link__Receipts-V3';
    ...
    */
     ...
     * Sets rel
     *
     * @param string|null $rel The relation type of the link. See also https://www.iana.org/assignments/link-relations/link-relations.xhtml. The relation type 'next' is used for paging. The relation type 'self' refers to the url of the resource
     *
     * @return self
     */

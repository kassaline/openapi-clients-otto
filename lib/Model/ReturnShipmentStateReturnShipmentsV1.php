 ...
 */
class ReturnShipmentStateReturnShipmentsV1 implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('occurredOn', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['occurredOn'] === null) {
            $invalidProperties[] = "'occurredOn' can't be null";
        }
    ...
    {
        return $this->container['occurredOn'];
    }

    /**
     * Sets occurredOn
     *
     * @param  string  $occurredOn  occurredOn
     * @return self
     */
    public function setOccurredOn($occurredOn)
    {
        if (is_null($occurredOn)) {
            throw new \InvalidArgumentException('non-nullable occurredOn cannot be null');
        }
        $this->container['occurredOn'] = $occurredOn;
     ...
     * Sets statusText
     *
     * @param  string|null  $statusText  Optional information from the carrier detailing the tracking state.
     * @return self
     */

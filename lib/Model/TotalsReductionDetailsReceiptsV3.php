...
/**
 * TotalsReductionDetailsReceiptsV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class TotalsReductionDetailsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TotalsReductionDetails__Receipts-V3';
    ...
    */
     ...
     * Sets voucherCode
     *
     * @param string|null $voucherCode The code of voucher associated with the receipt (contains only last 4 digits of code)
     *
     * @return self
     */

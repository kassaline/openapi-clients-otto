 ...
 */
class AvailableQuantityResponseDTOV2QuantitiesV2 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AvailableQuantityResponseDTOV2__Quantities-V2';
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'int',
        'sku' => 'string',
        'links' => '\OpenAPI\Client\Otto\Model\LinkQuantitiesV2[]',
    ];
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantityResponseDTOV2QuantitiesV2., must be smaller than or equal to 999999999.');
        }
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantityResponseDTOV2QuantitiesV2., must be bigger than or equal to 0.');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Otto\Model\LinkQuantitiesV2[]
     */
     ...
     * Sets links
     *
     * @param  \OpenAPI\Client\Otto\Model\LinkQuantitiesV2[]  $links  contains links to prev, self and next page url's
     * @return self
     */

 ...
 */
class NormPriceInfoProductsV3 implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NormPriceInfo__Products-V3';
    ...
    public const NORM_AMOUNT_1 = 1;

    public const NORM_AMOUNT_100 = 100;

    public const NORM_AMOUNT_1000 = 1000;

...
class ShipmentsV1Api
{
     ...
     * @throws \InvalidArgumentException
     */
    public function shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST($createShipmentRequestShipmentsV1, string $contentType = self::contentTypes['shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'][0])
    {
        [$response] = $this->shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTWithHttpInfo($createShipmentRequestShipmentsV1, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTWithHttpInfo($createShipmentRequestShipmentsV1, string $contentType = self::contentTypes['shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'][0])
    {
        $request = $this->shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTRequest($createShipmentRequestShipmentsV1, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTAsync($createShipmentRequestShipmentsV1, string $contentType = self::contentTypes['shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'][0])
    {
        return $this->shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTAsyncWithHttpInfo($createShipmentRequestShipmentsV1, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTAsyncWithHttpInfo($createShipmentRequestShipmentsV1, string $contentType = self::contentTypes['shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'][0])
    {
        $returnType = '\OpenAPI\Client\Otto\Model\CreateMultiparcelShipmentResponseShipmentsV1';
        $request = $this->shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTRequest($createShipmentRequestShipmentsV1, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOSTRequest($createShipmentRequestShipmentsV1, string $contentType = self::contentTypes['shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'][0])
    {
        ...
        if ($createShipmentRequestShipmentsV1 === null || (is_array($createShipmentRequestShipmentsV1) && count($createShipmentRequestShipmentsV1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $createShipmentRequestShipmentsV1 when calling shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST'
            );
        }
        if (count($createShipmentRequestShipmentsV1) < 2) {
            throw new \InvalidArgumentException('invalid value for "$createShipmentRequestShipmentsV1" when calling ShipmentsV1Api.shipmentsV1CreatedAndSentMultiparcelShipmentUsingPOST, number of items must be greater than or equal to 2.');
        }
    ...
    {
        [$response] = $this->shipmentsV1CreatedAndSentShipmentUsingPOSTWithHttpInfo($createShipmentRequestShipmentsV1, $contentType);
    ...
    {
        [$response] = $this->shipmentsV1ListShipmentsUsingGETWithHttpInfo($datefrom, $limit, $next, $contentType);
    ...
    {
        [$response] = $this->shipmentsV1ShipmentByCarrierAndTrackingNumberUsingGETWithHttpInfo($carrier, $trackingNumber, $contentType);
    ...
    {
        [$response] = $this->shipmentsV1ShipmentUsingGETWithHttpInfo($shipmentId, $contentType);

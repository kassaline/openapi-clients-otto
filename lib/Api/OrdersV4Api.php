...
class OrdersV4Api
{
     ...
     *
     * @param  string  $fromDate  Defines earliest change date (ISO 8601) the returned orders should have (optional)
     * @param  string  $fromOrderDate  Only orders newer than the date specified (ISO 8601) will be returned (optional)
     * @param  string  $toOrderDate  Only orders older than the date specified (ISO 8601) will be returned (optional)
     ...
     * @param  string  $orderDirection  Sort result by &#39;orderColumnType&#39; in ASCending or DESCending order (optional, default to 'ASC')
     * @param  string  $orderColumnType  The column on which to apply &#39;orderDirection&#39; parameter (optional, default to 'ORDER_LIFECYCLE_DATE')
    ...
    {
        [$response] = $this->ordersV4FindPartnerOrdersWithHttpInfo($fromDate, $fromOrderDate, $toOrderDate, $fulfillmentStatus, $limit, $orderDirection, $orderColumnType, $mode, $nextcursor, $contentType);
    ...
    {
        [$response] = $this->ordersV4GetPartnerOrderByOrderNumberWithHttpInfo($orderNumber, $contentType);
    ...
    {
        [$response] = $this->ordersV4GetPartnerOrderBySalesOrderIdWithHttpInfo($salesOrderId, $contentType);

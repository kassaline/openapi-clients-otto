...
class QuantitiesV2Api
{
     ...
     * @return \OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2
     *
     ...
     * @param  string  $cursor  Cursor for paging requests. If a cursor is provided, the only other request parameter being considered is &#39;limit&#39;. The cursor value is the last evaluted sku in the request response (Needs to be a valid sku value) (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['quantitiesV2GetAvailableQuantities'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantitiesWithHttpInfo($limit = 200, $page = 0, $cursor = null, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantities'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            }

            $returnType = '\OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\AvailableQuantityResponseV2QuantitiesV2',
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantitiesAsync($limit = 200, $page = 0, $cursor = null, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantities'][0])
    {
        return $this->quantitiesV2GetAvailableQuantitiesAsyncWithHttpInfo($limit, $page, $cursor, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantitiesRequest($limit = 200, $page = 0, $cursor = null, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantities'][0])
    {
     ...
     * @return \OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param  string  $sku  The sku for the available quantity (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['quantitiesV2GetAvailableQuantityBySku'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantityBySkuWithHttpInfo($sku, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantityBySku'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            }

            $returnType = '\OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\AvailableQuantitySingleResponseDTOV2QuantitiesV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantityBySkuAsync($sku, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantityBySku'][0])
    {
        return $this->quantitiesV2GetAvailableQuantityBySkuAsyncWithHttpInfo($sku, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2GetAvailableQuantityBySkuRequest($sku, string $contentType = self::contentTypes['quantitiesV2GetAvailableQuantityBySku'][0])
    {
        ...
        $headers = $this->headerSelector->selectHeaders(
            ['application/json;charset=UTF-8', 'text/html', 'application/json'],
            $contentType,
            $multipart
        );
     ...
     *
     * @param  \OpenAPI\Client\Otto\Model\AvailableQuantityRequestDTOV2QuantitiesV2[]  $availableQuantityRequestDTOV2QuantitiesV2  availableQuantityRequestDTO (required)
     ...
     * @return object|\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2|\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOST($availableQuantityRequestDTOV2QuantitiesV2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        [$response] = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTWithHttpInfo($availableQuantityRequestDTOV2QuantitiesV2, $contentType);
     ...
     * @param  \OpenAPI\Client\Otto\Model\AvailableQuantityRequestDTOV2QuantitiesV2[]  $availableQuantityRequestDTOV2QuantitiesV2  availableQuantityRequestDTO (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'] to see the possible values for this operation
     * @return array of object|\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2|\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTWithHttpInfo($availableQuantityRequestDTOV2QuantitiesV2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($availableQuantityRequestDTOV2QuantitiesV2, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                ...
                case 207:
                    if ('\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 413:
                    if ('\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 422:
                    if ('\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\UpdateQuantityMultiStatusResponseQuantitiesV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 413:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\PayloadTooLargeApiErrorResponseV2QuantitiesV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\ApiErrorResponseV2QuantitiesV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsync($availableQuantityRequestDTOV2QuantitiesV2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        return $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($availableQuantityRequestDTOV2QuantitiesV2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($availableQuantityRequestDTOV2QuantitiesV2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        $returnType = 'object';
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($availableQuantityRequestDTOV2QuantitiesV2, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($availableQuantityRequestDTOV2QuantitiesV2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {

        // verify the required parameter 'availableQuantityRequestDTOV2QuantitiesV2' is set
        if ($availableQuantityRequestDTOV2QuantitiesV2 === null || (is_array($availableQuantityRequestDTOV2QuantitiesV2) && count($availableQuantityRequestDTOV2QuantitiesV2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $availableQuantityRequestDTOV2QuantitiesV2 when calling quantitiesV2StoreAvailableQuantitiesUsingPOST'
            );
        }
        ...
        // for model (json/xml)
        if (isset($availableQuantityRequestDTOV2QuantitiesV2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($availableQuantityRequestDTOV2QuantitiesV2));
            } else {
                $httpBody = $availableQuantityRequestDTOV2QuantitiesV2;
            }

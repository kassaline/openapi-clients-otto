...
class PriceReductionsV1Api
{
    ...
    {
        [$response] = $this->priceReductionsV1ApplyPriceReductionWithHttpInfo($partnerPriceReductionRequestPriceReductionsV1, $contentType);
     ...
     *
     * @param  string  $positionItemId  positionItemId for which price reductions are to be fetched (optional)
    ...
    {
        [$response] = $this->priceReductionsV1GetAllReductionsForPartnerWithHttpInfo($positionItemId, $page, $limit, $contentType);

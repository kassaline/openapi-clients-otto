...
class ReturnsV2Api
{
    ...
    /**
     * Operation returnsV2GetPositionItemsForUsingGETV2
     *
     ...
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'] to see the possible values for this operation
     * @return \OpenAPI\Client\Otto\Model\PositionItemListReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2GetPositionItemsForUsingGETV2($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
        [$response] = $this->returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit, $page, $status, $contentType);

        return $response;
    }

    /**
     * Operation returnsV2GetPositionItemsForUsingGETV2WithHttpInfo
     *
     * Get all the items filtered on return status
     *
     * @param  int  $limit  Page size to limit the number of items returned in the response. Maximum value for limit can 50 (optional, default to 10)
     ...
     * @param  string  $status  Return status for which items are being queried for (case-insensitive) (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\PositionItemListReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
        $request = $this->returnsV2GetPositionItemsForUsingGETV2Request($limit, $page, $status, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
                    if ('\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation returnsV2GetPositionItemsForUsingGETV2Async
     *
     * Get all the items filtered on return status
     *
     * @param  int  $limit  Page size to limit the number of items returned in the response. Maximum value for limit can 50 (optional, default to 10)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2GetPositionItemsForUsingGETV2Async($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
        return $this->returnsV2GetPositionItemsForUsingGETV2AsyncWithHttpInfo($limit, $page, $status, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation returnsV2GetPositionItemsForUsingGETV2AsyncWithHttpInfo
     *
     * Get all the items filtered on return status
     *
     * @param  int  $limit  Page size to limit the number of items returned in the response. Maximum value for limit can 50 (optional, default to 10)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2GetPositionItemsForUsingGETV2AsyncWithHttpInfo($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
        $returnType = '\OpenAPI\Client\Otto\Model\PositionItemListReturnsV2';
        $request = $this->returnsV2GetPositionItemsForUsingGETV2Request($limit, $page, $status, $contentType);
    ...
    /**
     * Create request for operation 'returnsV2GetPositionItemsForUsingGETV2'
     *
     * @param  int  $limit  Page size to limit the number of items returned in the response. Maximum value for limit can 50 (optional, default to 10)
     * @param  int  $page  Page number to fetch. This parameter is required to fetch data for specific page number (optional, default to 1)
     * @param  string  $status  Return status for which items are being queried for (case-insensitive) (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2GetPositionItemsForUsingGETV2Request($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
    ...
    /**
     * Operation returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2
     *
     * Accept the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\AcceptedPartnerReturnV2ReturnsV2  $acceptedPartnerReturnV2ReturnsV2  acceptedPartnerReturn (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'] to see the possible values for this operation
     * @return object|\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2($acceptedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        [$response] = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($acceptedPartnerReturnV2ReturnsV2, $contentType);

        return $response;
    }

    /**
     * Operation returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo
     *
     * Accept the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\AcceptedPartnerReturnV2ReturnsV2  $acceptedPartnerReturnV2ReturnsV2  acceptedPartnerReturn (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'] to see the possible values for this operation
     * @return array of object|\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($acceptedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($acceptedPartnerReturnV2ReturnsV2, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                ...
                case 207:
                    if ('\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\AcceptedReturnMultiStatusResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Async
     *
     * Accept the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\AcceptedPartnerReturnV2ReturnsV2  $acceptedPartnerReturnV2ReturnsV2  acceptedPartnerReturn (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Async($acceptedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        return $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($acceptedPartnerReturnV2ReturnsV2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo
     *
     * Accept the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\AcceptedPartnerReturnV2ReturnsV2  $acceptedPartnerReturnV2ReturnsV2  acceptedPartnerReturn (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($acceptedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($acceptedPartnerReturnV2ReturnsV2, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($acceptedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {

        // verify the required parameter 'acceptedPartnerReturnV2ReturnsV2' is set
        if ($acceptedPartnerReturnV2ReturnsV2 === null || (is_array($acceptedPartnerReturnV2ReturnsV2) && count($acceptedPartnerReturnV2ReturnsV2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $acceptedPartnerReturnV2ReturnsV2 when calling returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'
            );
        }
        ...
        // for model (json/xml)
        if (isset($acceptedPartnerReturnV2ReturnsV2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($acceptedPartnerReturnV2ReturnsV2));
            } else {
                $httpBody = $acceptedPartnerReturnV2ReturnsV2;
            }
    ...
    /**
     * Operation returnsV2ReceiveRejectedReturnsV2UsingPOSTV2
     *
     * Reject the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\RejectedPartnerReturnV2ReturnsV2  $rejectedPartnerReturnV2ReturnsV2  rejectedPartnerReturn (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'] to see the possible values for this operation
     * @return object|\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2($rejectedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        [$response] = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejectedPartnerReturnV2ReturnsV2, $contentType);

        return $response;
    }

    /**
     * Operation returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo
     *
     * Reject the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\RejectedPartnerReturnV2ReturnsV2  $rejectedPartnerReturnV2ReturnsV2  rejectedPartnerReturn (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'] to see the possible values for this operation
     * @return array of object|\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2|\OpenAPI\Client\Otto\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejectedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejectedPartnerReturnV2ReturnsV2, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                ...
                case 207:
                    if ('\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Otto\Model\RejectedReturnMultiStatusResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Async
     *
     * Reject the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\RejectedPartnerReturnV2ReturnsV2  $rejectedPartnerReturnV2ReturnsV2  rejectedPartnerReturn (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Async($rejectedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        return $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejectedPartnerReturnV2ReturnsV2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo
     *
     * Reject the return for a sent position item (up to 200 items per request)
     *
     * @param  \OpenAPI\Client\Otto\Model\RejectedPartnerReturnV2ReturnsV2  $rejectedPartnerReturnV2ReturnsV2  rejectedPartnerReturn (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejectedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejectedPartnerReturnV2ReturnsV2, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejectedPartnerReturnV2ReturnsV2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {

        // verify the required parameter 'rejectedPartnerReturnV2ReturnsV2' is set
        if ($rejectedPartnerReturnV2ReturnsV2 === null || (is_array($rejectedPartnerReturnV2ReturnsV2) && count($rejectedPartnerReturnV2ReturnsV2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rejectedPartnerReturnV2ReturnsV2 when calling returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'
            );
        }
        ...
        // for model (json/xml)
        if (isset($rejectedPartnerReturnV2ReturnsV2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rejectedPartnerReturnV2ReturnsV2));
            } else {
                $httpBody = $rejectedPartnerReturnV2ReturnsV2;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

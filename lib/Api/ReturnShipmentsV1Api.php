...
class ReturnShipmentsV1Api
{
     ...
     * @return \OpenAPI\Client\Otto\Model\ReturnShipmentListReturnShipmentsV1|mixed|\OpenAPI\Client\Otto\Model\InternalServerErrorGetReturnShipmentListReturnShipmentsV1
     *
    ...
    {
        [$response] = $this->returnShipmentsV1ListReturnShipmentsUsingGETWithHttpInfo($datefrom, $limit, $next, $contentType);
     ...
     * @param  string  $next  The cursor which points to the next returnShipment that should be queried. It is used to paginate the results. (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnShipmentsV1ListReturnShipmentsUsingGET'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\ReturnShipmentListReturnShipmentsV1|mixed|\OpenAPI\Client\Otto\Model\InternalServerErrorGetReturnShipmentListReturnShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->returnShipmentsV1ReturnShipmentByCarrierAndTrackingNumberUsingGETWithHttpInfo($carrier, $trackingNumber, $contentType);
     ...
     * @return \OpenAPI\Client\Otto\Model\ReturnShipmentReturnShipmentsV1|mixed|\OpenAPI\Client\Otto\Model\ForbiddenGetReturnShipmentByReturnShipmentIdReturnShipmentsV1|\OpenAPI\Client\Otto\Model\NotFoundGetReturnShipmentByReturnShipmentIdReturnShipmentsV1|\OpenAPI\Client\Otto\Model\InternalServerErrorGetReturnShipmentByReturnShipmentIdReturnShipmentsV1
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    ...
    {
        [$response] = $this->returnShipmentsV1ReturnShipmentUsingGETWithHttpInfo($returnShipmentId, $contentType);
     ...
     * @param  string  $returnShipmentId  Internal return shipment identifier assigned by OTTO Market. (required)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['returnShipmentsV1ReturnShipmentUsingGET'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\ReturnShipmentReturnShipmentsV1|mixed|\OpenAPI\Client\Otto\Model\ForbiddenGetReturnShipmentByReturnShipmentIdReturnShipmentsV1|\OpenAPI\Client\Otto\Model\NotFoundGetReturnShipmentByReturnShipmentIdReturnShipmentsV1|\OpenAPI\Client\Otto\Model\InternalServerErrorGetReturnShipmentByReturnShipmentIdReturnShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */

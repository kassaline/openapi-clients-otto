...
class ReceiptsV3Api
{
    ...
    {
        [$response] = $this->receiptsV3GetReceiptUsingGET5WithHttpInfo($receiptNumber, $contentType);
     ...
     * @param  int  $page  Page number to fetch. This parameter is required to fetch data for specific page number. &lt;/br&gt;This field is deprecated, please use &#x60;next&#x60; parameter (optional, default to 1) (deprecated)
     * @param  string[]  $receiptTypes  Search for receipts filtered by multiple receipt types (optional)
     * @param  \DateTime  $from  Search for receipts to filter starting from (yyyy-mm-dd) (optional)
     * @param  \DateTime  $to  Search for receipts to filter until (yyyy-mm-dd) (optional)
     * @param  string  $salesOrderId  Search for receipts filtered by sales order Id (optional)
    ...
    {
        [$response] = $this->receiptsV3GetReceiptsUsingGET5WithHttpInfo($limit, $page, $receiptTypes, $from, $to, $salesOrderId, $next, $contentType);

...
class ProductsV3Api
{
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\ProductVariationProductsV3[]  $productVariationProductsV3  productVariationProductsV3 (optional)
    ...
    {
        [$response] = $this->productsV3CreateOrUpdateProductVariationsWithHttpInfo($xRequestTimestamp, $productVariationProductsV3, $contentType);
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\ProductVariationProductsV3[]  $productVariationProductsV3  (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['productsV3CreateOrUpdateProductVariations'] to see the possible values for this operation
    ...
    {
        [$response] = $this->productsV3FailedByProcessIdWithHttpInfo($processUuid, $contentType);
     ...
     * @param  string  $productReference  search for product variations by their productReference value (optional)
     * @param  string  $category  search for product variations by their category value (optional)
     * @param  string  $brandId  search for product variations by their brand ID value (optional)
    ...
    {
        [$response] = $this->productsV3GetActiveStatusWithHttpInfo($sku, $productReference, $category, $brandId, $page, $limit, $contentType);
     ...
     *
     * @param  string  $ifMatch  The RFC7232 If-Match header field in a request requires the server to only operate on the resource that matches at least one of the provided entity-tags. This allows clients express a precondition that prevent the method from being applied if there have been any changes to the resource (see [RFC 7232 Section 3.1](https://tools.ietf.org/html/rfc7232#section-3.1). (optional)
     * @param  string  $ifNoneMatch  The RFC7232 If-None-Match header field in a request requires the server to only operate on the resource if it does not match any of the provided entity-tags. If the provided entity-tag is &#x60;*&#x60;, it is required that the resource does not exist at all (see [RFC 7232 Section 3.2](https://tools.ietf.org/html/rfc7232#section-3.2) (optional)
     * @param  string  $ifModifiedSince  The RFC7232 If-Modified-Since header field makes a GET or HEAD request method conditional on the selected representation&#39;s modification date being more recent than the date provided in the field-value. Transfer of the selected representation&#39;s data is avoided if that data has not changed. (optional)
     * @param  string  $ifUnmodifiedSince  The RFC7232 If-Unmodified-Since header field makes the request method conditional on the selected representation&#39;s last modification date being earlier than or equal to the date provided in the field-value. This field accomplishes the same purpose as If-Match for cases where the user agent does not have an entity-tag for the representation. (optional)
     * @param  int  $page  page (optional)
    ...
    {
        [$response] = $this->productsV3GetBrandsWithHttpInfo($ifMatch, $ifNoneMatch, $ifModifiedSince, $ifUnmodifiedSince, $page, $limit, $contentType);
    ...
    {
        [$response] = $this->productsV3GetCategoryGroupsWithHttpInfo($page, $limit, $category, $contentType);
     ...
     * @param  \DateTime  $fromDate  search for content changes from this time on. The maxmimum and default value is 28 days before now. Future values can be specified, but lead to an empty result. (optional)
     * @param  int  $page  page (optional)
    ...
    {
        [$response] = $this->productsV3GetContentChangesWithHttpInfo($sku, $fromDate, $page, $limit, $contentType);
    ...
    {
        [$response] = $this->productsV3GetContentChanges2WithHttpInfo($sku, $fromDate, $page, $limit, $contentType);
    ...
    {
        [$response] = $this->productsV3GetMarketPlaceStatusWithHttpInfo($sku, $contentType);
     ...
     *
     * @param  string  $sku  search for product variations by their sku value. Use this if your sku values contain slash (&#39;/&#39;) or dot (&#39;.&#39;) characters. (optional)
     * @param  string  $productReference  search marketplace status by the productReference value of the related product variations (optional)
     * @param  string  $category  search marketplace status by the category value of the related product variations (optional)
     * @param  string  $brandId  search marketplace status by the brand ID value of the related product variations (optional)
     * @param  \DateTime  $fromDate  search marketplace status for a time range starting with the given date (in ISO8601, like &#39;2021-10-09T07:52:19.820Z&#39; or &#39;2021-10-09T07:52:19.820+01:00&#39;) (optional)
     ...
     * @param  string[]  $marketPlaceStatus  only include items that match any of the provided status (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function productsV3GetMarketPlaceStatusList($sku = null, $productReference = null, $category = null, $brandId = null, $fromDate = null, $page = null, $limit = null, $marketPlaceStatus = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        [$response] = $this->productsV3GetMarketPlaceStatusListWithHttpInfo($sku, $productReference, $category, $brandId, $fromDate, $page, $limit, $marketPlaceStatus, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function productsV3GetMarketPlaceStatusListWithHttpInfo($sku = null, $productReference = null, $category = null, $brandId = null, $fromDate = null, $page = null, $limit = null, $marketPlaceStatus = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $productReference, $category, $brandId, $fromDate, $page, $limit, $marketPlaceStatus, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function productsV3GetMarketPlaceStatusListAsync($sku = null, $productReference = null, $category = null, $brandId = null, $fromDate = null, $page = null, $limit = null, $marketPlaceStatus = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        return $this->productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku, $productReference, $category, $brandId, $fromDate, $page, $limit, $marketPlaceStatus, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku = null, $productReference = null, $category = null, $brandId = null, $fromDate = null, $page = null, $limit = null, $marketPlaceStatus = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        $returnType = '\OpenAPI\Client\Otto\Model\MarketPlaceStatusApiResultProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $productReference, $category, $brandId, $fromDate, $page, $limit, $marketPlaceStatus, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function productsV3GetMarketPlaceStatusListRequest($sku = null, $productReference = null, $category = null, $brandId = null, $fromDate = null, $page = null, $limit = null, $marketPlaceStatus = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
     ...
     * @param  string  $productReference  search for product variations by their productReference value (optional)
     * @param  string  $category  search for product variations by their category value (optional)
     * @param  string  $brandId  search for product variations by their brandId value (optional)
     * @param  int  $page  page (optional)
    ...
    {
        [$response] = $this->productsV3GetPartnerProductsWithHttpInfo($sku, $productReference, $category, $brandId, $page, $limit, $contentType);
    ...
    {
        [$response] = $this->productsV3GetProductVariationWithHttpInfo($sku, $contentType);
    ...
    {
        [$response] = $this->productsV3GetProductVariationPriceWithHttpInfo($sku, $contentType);
     ...
     * @param  string  $productReference  search for product variations by their productReference value (optional)
     * @param  string  $category  search for product variations by their category value (optional)
     * @param  string  $brandId  search for product variations by their ID value (optional)
     * @param  int  $page  page (optional)
     * @param  int  $limit  proposed limit for the number of products per response page (at most 100) (optional)
    ...
    {
        [$response] = $this->productsV3GetProductVariationPricesWithHttpInfo($sku, $productReference, $category, $brandId, $page, $limit, $contentType);
    ...
    {
        [$response] = $this->productsV3GetVariationActiveStatusWithHttpInfo($sku, $contentType);
    ...
    {
        [$response] = $this->productsV3ProgressByProcessIdWithHttpInfo($processUuid, $contentType);
    ...
    {
        [$response] = $this->productsV3SucceededByProcessIdWithHttpInfo($processUuid, $contentType);
    ...
    {
        [$response] = $this->productsV3UnchangedByProcessIdWithHttpInfo($processUuid, $contentType);
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\ActiveStatusListRequestProductsV3  $activeStatusListRequestProductsV3  activeStatusListRequestProductsV3 (optional)
    ...
    {
        [$response] = $this->productsV3UpdateActiveStatusWithHttpInfo($xRequestTimestamp, $activeStatusListRequestProductsV3, $contentType);
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\ActiveStatusListRequestProductsV3  $activeStatusListRequestProductsV3  (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['productsV3UpdateActiveStatus'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\SkuPricingProductsV3[]  $skuPricingProductsV3  skuPricingProductsV3 (optional)
    ...
    {
        [$response] = $this->productsV3UpdateProductVariationPricesWithHttpInfo($xRequestTimestamp, $skuPricingProductsV3, $contentType);
     ...
     *
     * @param  string  $xRequestTimestamp  Holds the optional client side update request timestamp, in ISO DateTime format (optional)
     * @param  \OpenAPI\Client\Otto\Model\SkuPricingProductsV3[]  $skuPricingProductsV3  (optional)
     * @param  string  $contentType  The value for the Content-Type header. Check self::contentTypes['productsV3UpdateProductVariationPrices'] to see the possible values for this operation
     * @return array of \OpenAPI\Client\Otto\Model\ProductProcessProgressProductsV3, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws \OpenAPI\Client\Otto\ApiException on non-2xx response or if the response body is not in the expected format
